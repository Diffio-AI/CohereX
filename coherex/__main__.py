...
def cli():
    ...
    parser.add_argument("--align_model", default=None, help="alignment model id or local path. For `wav2vec2`, this is a CTC model; for `qwen3`, this defaults to Qwen/Qwen3-ForcedAligner-0.6B")
    parser.add_argument("--align_backend", default="wav2vec2", choices=["wav2vec2", "qwen3"], help="forced alignment backend to use")
