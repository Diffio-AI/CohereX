...
class RelPositionMultiHeadAttention(nn.Module):
    ...
    def forward(self, x, pos_emb, mask=None):
        ...
        if mask is not None:
            ...
            scores = scores.masked_fill(expanded_mask, _mask_fill_value(scores.dtype))
...
class CohereAsrForConditionalGeneration(CohereAsrPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        self_attention_mask.masked_fill_(causal_bool[None, None, :, :], _mask_fill_value(dtype))
        ...
        if effective_decoder_mask is not None:
            ...
            key_padding = (1.0 - effective_decoder_mask[:, None, None, :].to(dtype=dtype)) * _mask_fill_value(dtype)
        ...
        if effective_cross_attention_mask is None:
            ...
            if encoder_lengths is not None:
                ...
                effective_cross_attention_mask = (1.0 - valid[:, None, None, :].to(dtype=dtype)) * _mask_fill_value(dtype)
